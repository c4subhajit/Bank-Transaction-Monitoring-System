...
Public Class frm_sa_new
    ...
    Private Sub frm_sa_new_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmd_ok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_ok.Click
        ...
        If MessageBox.Show("Confirm Record Insert?", "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            ...
            Else
                ...
                caconstrg = "insert into ACCOUNTS (acno,acctype,bankname,bname,opendate,dot,intrate,balance)values(" & _
                txt_an.Text & ",'SAVINGS ACCOUNT','" & UCase(txt_bn.Text) & "','" & UCase(txt_brn.Text) & "','" & _
                Trim(CDate(txt_dot.Text)) & "','" & Trim(CDate(txt_dot.Text)) & "'," & txt_ir.Text & "," & txt_blnc.Text & ")"
                ...
                If cmb_toa.SelectedItem = "Savings Account" Then
                    ...
                    If Not txt_tan.Text = "" Then
                        ...
                        tostr = "SA ACCOUNT NO. " & txt_an.Text
    ...
    Public Sub txt_tan_validate()
        ...
        If Not txt_tan.Text = "" Then
            saconstrg = "select * from ACCOUNTS where (acno = " & txt_tan.Text & " and acctype = '" & acctype & "')"
            saconcmd = New OleDbCommand(saconstrg, dbcon)
            datareader = saconcmd.ExecuteReader()
            datareader.Read()
