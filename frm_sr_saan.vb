...
Public Class frm_sr_saan
    ...
    Private Sub frm_sr_saan_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmd_search_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_search.Click
        ...
        constrg1 = "select bankname,bname,dot,intrate,balance from ACCOUNTS where acno = " & txt_an.Text & " and acctype = 'SAVINGS ACCOUNT'"
        ...
        If datareader.HasRows Then
            ...
            txt_ir.Text = datareader.Item(3)
            txt_bl.Text = datareader.Item(4)
